...
<div class="blok_filter mb2">
  ...
  <div>Kalender <span class=debug id=last_keyword>last_keyword</span></div>
  <div>
    <input class="form-control" id=keyword placeholder="Kurikulum ...">
  </div>

</div>
<div id="blok_list_kalender"></div>
...
<script>
  $(function(){
    $("#keyword").keyup(function(){
      ...
      let link_ajax = `ajax_akademik/ajax_get_list_kalender.php?keyword=${keyword}&id_prodi=${id_prodi}&angkatan=${angkatan}&`;
      $("#debug1").text(link_ajax);
      $.ajax({
        url:link_ajax,
        success:function(a){
          $("#blok_list_kalender").html(a);
        }
      })
