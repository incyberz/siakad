...
for ($i=0; $i < count($rmaster); $i++) { 
  ...
  <div class='item-master'>
    <div><a href='?master&p=$rmaster[$i]'>manage<br> $text</a></div>
  </div>
  ";
}
...
<div class="manage-home">
  <?php  echo "$ui_master[jalur] $ui_master[kelas] $ui_master[shift_kelas]";?>
</div>
...
<div class="manage-home">
  <?php  echo "$ui_master[kurikulum] $ui_master[kurikulum_semester] $ui_master[kurikulum_semester_mk]";?>
</div>
