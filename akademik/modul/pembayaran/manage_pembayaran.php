...
while ($d=mysqli_fetch_assoc($q)) {
  ...
  <tr>
    <td>$i</td>
    <td>
      <div class=darkblue>$d[nama_pembayar]</div>
    ...
    <td>
      <button class='btn btn-success btn-sm btn_aksi' id=verif__$d[id]>Verifikasi</button>
      <button class='btn btn-danger btn-sm btn_aksi' id=reject__$d[id]>Reject</button>
    </td>
  </tr>
  ";
}
...
$table = $tr=='' ? div_alert('info','Belum ada data pembayaran yang perlu diverifikasi.') 
  ...
  $(function(){
    $('.btn_aksi').click(function(){
      ...
      if(aksi=='show_bukti'){
        ...
        let link_ajax = `ajax_akademik/ajax_verif_bukti_bayar.php`;
