...
<?php
$s = "SELECT a.*, b.id as id_kurikulum, c.nama as nama_prodi FROM tb_kalender a 
...
while ($d=mysqli_fetch_assoc($q)) {
  ...
  while ($d2=mysqli_fetch_assoc($q2)) {
    ...
    $input_tagihkan = $sudah_masuk_smt ? '<code>auto</code>' : "
    <div>
...
?>
<?=$tb?>
<div class='kecil miring abu'>*) Penagihan <code>auto</code> artinya otomatis ditagihkan ke mahasiswa saat sudah masuk tanggal semester.</div>
