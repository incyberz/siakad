...
$id_kelas_ta = isset($_GET['id_kelas_ta']) ? $_GET['id_kelas_ta'] : '';
...
$s = "SELECT * FROM tb_kelas_ta WHERE id=$id_kelas_ta";
$q = mysqli_query($cn,$s) or die(mysqli_error($cn));
...
<span id=id_kelas_ta class=debug>$id_kelas_ta</span> 
pada Tahun Ajar 
...
<script>
  $(function(){
    ...
    $(document).on("click",".btn_aksi",function(){
      ...
      let link_ajax = `ajax_akademik/ajax_set_kelas_mhs.php?id_mhs=${id_mhs}&kelas=${kelas}&aksi=${aksi}&id_kelas_angkatan_detail=${id_kelas_angkatan_detail}&id_kelas_ta=${id_kelas_ta}&`;
