...
$id_semester = isset($_GET['id_semester']) ? $_GET['id_semester'] : die("<script>location.replace('?manage_kurikulum&id_kurikulum=$id_kurikulum')</script>");
$no_semester = isset($_GET['no_semester']) ? $_GET['no_semester'] : die("<script>location.replace('?manage_kurikulum&id_kurikulum=$id_kurikulum')</script>");
