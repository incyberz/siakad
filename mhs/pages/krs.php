...
while ($d=mysqli_fetch_assoc($q)) {
  ...
  $link_isi_krs = $d['jumlah_mk']==0 ? '-' : "<a href='?isi_krs_manual&id_krs_manual=$d[id]' class='btn btn-success'>Isi KRS</a>";
...
<section id="krs" class="" data-aos="fade-left">
  <div class="container">
    <div class="section-title">
      <h2><?=$judul?></h2>
      <?=$info_kalender?>
      <p>Berikut adalah KRS untuk angkatan <b><u><?=$angkatan?></u></b> prodi <b><u><?=$nama_prodi?></u></b> <span class=debug id=id_prodi><?=$id_prodi?></span></p>
    </div>
    
    <table class="table table-striped">
      <?=$tr_krs?>
    </table>
    <div class="kecil miring abu">Semester aktif: Semester <?=$semester_aktif?> dari <?=$tanggal_awal_smt?> s.d <?=$tanggal_akhir_smt?></div>
